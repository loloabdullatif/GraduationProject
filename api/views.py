...
from graduationapp.models import Amenities, City, Governate, Images, PublicPlace, Service, Street, TouristaUser, Hotel
from api.serializer import AddFarmSerializer, AddRestaurantSerializer, CitySerializer, GovernorateSerializer, HotelResponseSerializer, PublicPlaceSerializer, StreetSerializer, UpdateDataSerializer, AddUserSerializer, UserReturnSerializer, AddHotelSerializer, ServiceSerializer, ImageSerializer, AmenitySerializer
