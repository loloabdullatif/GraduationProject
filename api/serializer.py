from graduationapp.models import City, Farm, Governate, Street, TouristaUser, Hotel,Amenities,Service,Images,Restaurant #we need the model we want to serialize
